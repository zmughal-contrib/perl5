...
The code stored by the C<FINALLY> block will be invoked when control leaves
...
If the flow of control does not reach the C<FINALLY> statement itself then its
